...
I considered taking a year into account, so typing "Sunday, Jan 1, 2001" would look in that year, instead of the year with the closest Jan 1. The tricky part is knowing that a year is _coming_ after, and deferring the alert until we can incorporate that data into the calculation.
